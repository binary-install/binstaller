...
1.7.0:tagpr_v1.7.0_darwin_arm64.zip:e60b0ba2934e72785236c76a5f7bcdc00c82a7f9b4d89feed74614c16469a8b9
1.7.0:tagpr_v1.7.0_linux_amd64.tar.gz:a256615cb5fac33e7f317fe7d3583aa300bb55a910c19499f9a67e7e39bfac79
1.7.0:tagpr_v1.7.0_linux_arm64.tar.gz:7492ec863f6aa5abaca0a239c4198258832fb8817130a1f3021595987361701c"
...
execute() {
  ...
  if [ -z "${EXT}" ] || [ "${EXT}" = ".exe" ]; then
    ...
    BINARY_PATH="${TMPDIR}/tagpr_${TAG}_${OS}_${ARCH}/tagpr"
  fi
